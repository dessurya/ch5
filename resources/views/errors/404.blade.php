...
<body>
	<!--start-wrap-->
		<div class="wrap">
			<!--start-content-->
			<div class="content">
				<img src="{{ asset('public/asset/picture-default/error-img.png') }}" title="error" />
				<p><span><label>O</label>hh.....</span>You Requested the page that is no longer There.</p>
				<a href="{{ Route('main.home') }}">Go To Home Page</a>
				<div class="copy-right">
					<p>&#169 All rights Reserved | Development By Porthole.CO | Designed by <a href="http://w3layouts.com/">W3Layouts</a></p>
				</div>
   			</div>
			<!--End-Cotent-->
		</div>
